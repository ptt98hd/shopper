                        ...
                        <div class="card mb-4">
                            <form action="product" method="post" class="p-5 bg-body-tertiary">
								...
								<div class="mb-3">
									...
									<input type="text" name="productName" value="${product.productName}" readonly disabled
										   class="form-control" id="productName">
								</div>
								<div class="mb-3">
									<label for="productImg" class="form-label">Image Link</label>
									<input type="text" name="productImg" value="${product.productImg}" readonly disabled
										   class="form-control" id="productImg">
								</div>
								<div class="mb-3">
									<label for="price" class="form-label">Price</label>
									<input type="number" name="price" value="<fmt:formatNumber value="${product.price}" groupingUsed="false"/>"
										   readonly disabled class="form-control" id="price">
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<select id="brandId" name="brandId" class="form-select" disabled>
								...
								<div class="mb-3">
									...
									<select id="colorId" name="colorId" class="form-select" disabled>
									...
									<c:forEach var="size" items="${sizes}">
										<div class="form-check-inline">
											<input type="checkbox" name="sizeIds" value="${size.key.sizeId}" ${size.value ? "checked" : ""}
												   id="size${size.key.sizeId}" class="form-check-input" disabled>
								...
								<div class="d-flex gap-3">
									<a href="/shopper/admin/product?get=update&productId=${product.productId}"
